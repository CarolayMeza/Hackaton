...
<title>Perfil de Agricultor</title>
</head>
<body>
    <jsp:include page="head4.jsp" />
    <main>
        <div class="titel">
            <h1>Nombre de Agricultor</h1>
        </div>
        ...
        <div class="container2">
            <div>
                <h4>Productos</h4>
                <img src="Imagen/arroz1.jpg" alt="Imagenes de la finca">
            </div>
            <div>
                <h4>Aliados</h4>
                <img src="Imagen/arro2.JPG" alt="Imagenes de la finca">
            </div>
            <div>
                <h4>Ubicación</h4>
                <img src="Imagen/fincaarroz1.jpg" alt="Imagenes de la finca">
            </div>
            <div>
                <h4> Estandares de calidad</h4>
                <img src="Imagen/fincaarroz2.jpg" alt="Imagenes de la finca">
            </div>
